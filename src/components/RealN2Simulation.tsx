...
// N2 public scoring rules + original auto-scored practice sets written in the
// published 問題1〜14 layout. 聴解 is kept out of this written-paper simulation;
// the listening block sits separately and uses original items only.
import { Link } from 'wouter';
import simulationData from '@/lib/realN2SimulationData.json';
import { RealN2Chokai } from './RealN2Chokai';
...
const STORAGE_KEY = 'jlpt_n2_simulation_state';
...
export interface RealN2SimulationProps {
  /**
...
export function RealN2Simulation({ examDay, replay }: RealN2SimulationProps = {}) {
  ...
  // 105-minute clock on the very first render so the set picker never flashes.
  useEffect(() => {
    if (!examDay) return;
  ...
  // ---------------------------------------------------------------------------
  // JLPT N2 is scored in THREE 60-point blocks:
          ...
          <div className="flex items-start gap-4 border-b border-border pb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-black tracking-tight text-foreground">
                2026 JLPT N2 Exam Day Checklist
              </h1>
              <p className="mt-1 text-sm text-muted-foreground">
                Mandatory rules, strict disqualification trigAn unofficial summary to help you pack and prepare — always confirm the current rules.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 space-y-8">
            ...
            <div className="rounded-2xl border border-destructive/30 bg-destructive/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-xs md:text-sm text-foreground/90 list-disc list-inside">
                ...
                <li>
                  <strong>聴解 happens separately:</strong> the listening paper is sat after the written paper and the room is locked once the audio starts. This simulation covers the written paper only — practise 聴解 with the listening block below (browser-voice audio) or with the organisers' own samples.
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-lg font-bold flex items-center gap-2 text-foreground">
                ...
                N2 Timings & Sectional Pass Matrix (per JLPT published guidelines)
              </h3>
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="p-4 rounded-2xl border border-border bg-background text-center">
                  ...
                  <p className="text-2xl font-black text-foreground mt-1">105 Minutes</p>
                ...
                <div className="p-4 rounded-2xl border border-border bg-background text-center">
                  ...
                  <p className="text-2xl font-black text-foreground mt-1">50 Minutes</p>
                  <p className="text-[11px] text-muted-foreground mt-1">Not simulated — 聴解 needs the exam audio</p>
                </div>
                <div className="p-4 rounded-2xl border border-border bg-background text-center">
                  <p className="text-xs text-muted-foreground font-mono uppercase">Practice split</p>
                  <p className="text-2xl font-black text-foreground mt-1">35 + 70</p>
  ...
  if (viewState === 'exam') {
    ...
    return (
      <div className="mx-auto max-w-[1020px] px-4 py-6 pb-28 md:px-8 md:py-8 md:pb-16 animate-fadeIn" data-testid="n2-sim-exam">
        {/* Status & Timer Bar */}
...
{q.section.toUpperCase()}
  ...
  if (viewState === 'result') {
    ...
    return (
      <div className="mx-auto max-w-[960px] px-4 py-8 pb-28 md:px-8 md:py-12 md:pb-16 animate-fadeIn" data-testid="n2-sim-result">
        <div className={`rounded-3xl border p-6 md:p-8 text-center shadow-lg transition ${
          ...
          <h2 className="text-2xl md:text-3xl font-black text-foreground">
            {isPassed ? 'N2 WRITTEN PAPER CLEARED — Benchmarks Met!' : 'N2 WRITTEN PAPER BELOW BENCHMARK'}
          </h2>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl mx-auto">
            <div className="p-3.5 rounded-2xl border border-border bg-card text-center">
              ...
              <p className="text-2xl font-black text-foreground mt-1" data-testid="n2-lang-score">{langKnowledgeScore} / 60</p>
            ...
            <div className="p-3.5 rounded-2xl border border-border bg-card text-center">
              ...
              <p className="text-2xl font-black text-foreground mt-1" data-testid="n2-reading-score">{readingScore} / 60</p>
            ...
            <div className="p-3.5 rounded-2xl border border-border bg-card text-center">
              ...
              <p className="text-2xl font-black text-foreground mt-1" data-testid="n2-listening-score">{listeningScore === null ? 'Not taken' : `${listeningScore}/60`}</p>
          ...
          <div className="mt-5 rounded-2xl border border-border bg-card p-4 text-xs text-muted-foreground">
            ...
            A full N2 合否 needs the 聴解 block as well: ≥ 19/60 there and ≥ 90/180 overall.
          </div>
        ...
        <div className="mt-10">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Japanese explanations for every 問題1〜14 item, in 問題 order.</p>
            </div>

            <div className="flex items-center gap-1.5 rounded-xl border border-border p-1 bg-card text-xs">
              <button
                data-testid="n2-filter-all"
              ...
              <button
                data-testid="n2-filter-incorrect"
        ...
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-bold text-muted-foreground flex items-center gap-1">
              N2 Timings & Guidelines
            </span>
          </div>
          <h1 className="mt-2 text-2xl md:text-3xl font-black tracking-tight text-foreground">
JLPT N2 Written Examination Simulation
          </h1>
          <p className="mt-1 text-sm text-muted-foreground max-w-2xl">
            Sit the N2 written paper as one 105-minute block, or drill a single part with a practice split (文字・語彙 35分 / 文法・読解 70分). Every set is an original 問題1〜14 bank scored against the published N2 得点区分 — 言語知識 60点 and 読解 60点, 基準点 19点 each.
          </p>
        </div>
      ...
      <Link
        href="/jlpt-simulation/n2/exam-day"
        data-testid="n2-exam-day-banner"
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-black text-foreground">
              Full exam day — 言語知識・読解 105分 → 聴解 50分 → one 合否 verdict
            </p>
                ...
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-[11px] font-mono text-muted-foreground">
                      styled after {set.reference_sitting} · 問題1〜14 · 聴解 not included
                    </span>
                  </div>
                </div>
          ...
          >
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                The whole 言語知識・読解 paper under exam-like conditions
              </p>
            </div>
      ...
      {/* Original 聴解 practice block (browser voice) */}
      <RealN2Chokai />
    </div>
  );
}